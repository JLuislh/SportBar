 ...
 * @author jluis
 */
public class MenuShotsLicos extends javax.swing.JPanel {
     int id_pedido = 0;
     int id_producto = 0;
    ...
    private void initComponents() {
        ...
        T2.setText("JOHNY WALKER RED LABEL");
        ...
        P2Layout.setHorizontalGroup(
            ...
            .addGroup(P2Layout.createSequentialGroup()
                .addComponent(T2, javax.swing.GroupLayout.PREFERRED_SIZE, 144, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        T3.setText("JOHNY WALKER BLACK LABEL");
        ...
        P4Layout.setVerticalGroup(
            P4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(T4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
        );
        ...
        P5Layout.setVerticalGroup(
            P5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(T5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
        );
        ...
        T7.setText("TEQUILA BLANCOREPOSADO");
        ...
        P7Layout.setVerticalGroup(
            P7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(T7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
        );
        ...
        T8.setText("TEQUILA VIUDA DE ROMERO");
        ...
        P8Layout.setVerticalGroup(
            ...
            .addGroup(P8Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(T8, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        T9.setText("VIUDA DE ROMERO BLANCO");
        ...
        P9Layout.setVerticalGroup(
            ...
            .addGroup(P9Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(T9, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        T10.setText("TEQUILA EL JIMADOR REPOSADO");
        ...
        P10Layout.setVerticalGroup(
            P10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(T10, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
        );
        ...
        P11Layout.setVerticalGroup(
            ...
            .addGroup(P11Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(T11, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        P12Layout.setVerticalGroup(
            ...
            .addGroup(P12Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(T12, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        T13.setText("RON ZACAPA CENTENARIO");
        ...
        P13Layout.setVerticalGroup(
            P13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(T13, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
        );
        ...
        P14Layout.setHorizontalGroup(
            ...
            .addGroup(P14Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(T14, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                .addContainerGap())
        );
        P14Layout.setVerticalGroup(
            P14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(T14, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
        );
    ...
    private void T1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T1MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){
            id_producto = 184; //SHOT RON BOTRAN XL
            BuscarExistencia();
    ...
    private void T2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T2MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){
            id_producto = 185; //SHOT JOHNNIE BLACK LABEL
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T3MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){
            id_producto = 186; //SHOT JOHNNIE RED LABEL
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T4MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){
          id_producto = 187; //SHOT BUCHANAN'S 12 AÑOS
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T5MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){
           id_producto = 188; //SHOT BUCHANAN'S 18 AÑOS
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T6MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T6MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){
            id_producto = 189; //SHOT OLD PARR 12 AÑOS
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T7MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T7MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){ 
            id_producto = 190; //SHOT TEQUILA BLANCO REPOSADO	25.00
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T8MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T8MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){ 
            id_producto = 191; //SHOT VIUDA DE ROMERO REPOSADO
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T9MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T9MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){ 
            id_producto = 192; //SHOT VIUDA DE ROMERO BLANCO
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T10MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T10MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){ 
           id_producto = 193;   //SHOT TEQUILA EL JIMADOR REPOSADO
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T11MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T11MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){ 
           id_producto = 194;  //SHOT DON JULIO 70
            BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T12MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T12MousePressed
        ...
        if ((evt.getModifiers() & 4) !=0){  
           id_producto = 195;  //SHOT DON JULIO BLANCO
           BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T13MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T13MousePressed
       if ((evt.getModifiers() & 4) !=0){  
           id_producto = 196; //SHOT RON ZACAPA CENTENARIO
           BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T14MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T14MousePressed
       if ((evt.getModifiers() & 4) !=0){   
           id_producto = 197; //SHOT RON BARCELO AÑEJO
           BuscarExistencia();
            if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    private void T15MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_T15MousePressed
       if ((evt.getModifiers() & 4) !=0){   
           id_producto = 198; //SHOT BODKA SMIRNOFF
           BuscarExistencia();
           if(existe >= 2){UpdateCantidadMenos();} else if (existe == 1){eliminarProducto();} else{JOptionPane.showMessageDialog(this, "Aun no tienes agregado este producto");}
    ...
    String texto1 = "<html><center><body>RON BOTRAN<br>XL<br><font color='RED'>Q35.00</font></body></center></html>";
        T1.setText(texto1);
    String texto2 = "<html><center><body>JOHNY WALKER<br>RED LABEL<br><font color='RED'>Q35.00</font></body></center></html>";
        T2.setText(texto2);
    String texto3 = "<html><center><body>JOHNY WALKER<br>BLACK LABEL<br><font color='RED'>Q40.00</font></body></center></html>";
        T3.setText(texto3);    
    String texto4 = "<html><center><body>BUCHANAN'S<br>12 AÑOS<br><font color='RED'>Q45.00</font></body></center></html>";
        T4.setText(texto4);
    String texto5 = "<html><center><body>BUCHANAN'S<br>18 AÑOS<br><font color='RED'>Q55.00</font></body></center></html>";
        T5.setText(texto5);    
    String texto6 = "<html><center><body>OLD PARR<br>12 AÑOS<br><font color='RED'>Q45.00</font></body></center></html>";
        T6.setText(texto6);    
    String texto7 = "<html><center><body>TEQUILA BLANCO<br>REPOSADO<br><font color='RED'>Q25.00</font></body></center></html>";
        T7.setText(texto7);
    String texto8 = "<html><center><body>TEQUILA VIUDA DE<br>ROMERO REPOSADO<br><font color='RED'>Q25.00</font></body></center></html>";
        T8.setText(texto8);
    String texto9 = "<html><center><body>VIUDA DE ROMERO<br>BLANCO<br><font color='RED'>Q25.00</center></html>";
        T9.setText(texto9);    
    String texto10 = "<html><center><body>TEQUILA <br>EL JIMADOR REPOSADO<br><font color='RED'>Q35.00</body></center></html>";
        T10.setText(texto10);
    String texto11 = "<html><center><body>DON JULIO 70<br><font color='RED'>Q45.00</body></center></html>";
        T11.setText(texto11);  
    String texto12 = "<html><center><body>DON JULIO<br>BLANCO<br><font color='RED'>Q45.00</body></center></html>";
        T12.setText(texto12);
        String texto13 = "<html><center><body>RON ZACAPA<br>CENTENARIO<br><font color='RED'>Q40.00</body></center></html>";
        T13.setText(texto13);
        String texto14 = "<html><center><body>RON BARCELO<br>AÑEJO<br><font color='RED'>Q30.00</body></center></html>";
        T14.setText(texto14);
        String texto15 = "<html><center><body>BODKA SMIRNOFF<br><font color='RED'>Q35.00</body></center></html>";
        T15.setText(texto15);
